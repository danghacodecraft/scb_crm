...
from app.api.v1.endpoints.user.schema import CurrentUserInfoResponse
...
async def _get_authorization_header(
    ...
    return CurrentUserInfoResponse(**result_check_token.data)
...
) -> Union[CurrentUserInfoResponse, None]:
