...
async def view_gw_send_email(
        ...
        data_input__email_to: Optional[List[EmailStr]] = Form(None, alias="sendEmail_in.data_input.email_to",
                                                              description="Địa chỉ email cần gửi, cần gửi tới nhiều người thì gửi lên nhiều key này, không có thì không gửi lên"),
        data_input__email_cc: Optional[List[EmailStr]] = Form(None, alias="sendEmail_in.data_input.email_cc",
                                                              description="Địa chỉ email cần cc, cần gửi tới nhiều người thì gửi lên nhiều key này, không có thì không gửi lên"),
        data_input__email_bcc: Optional[List[EmailStr]] = Form(None, alias="sendEmail_in.data_input.email_bcc",
                                                               description="Địa chỉ email cần bcc, cần gửi tới nhiều người thì gửi lên nhiều key này, không có thì không gửi lên"),
