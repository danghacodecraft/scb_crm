...
class SelectBranchByRegionIdItemResponse(BaseGWSchema):
    ...
    area_id: Optional[str] = Field(..., description="Mã khu vực")
    area_name: Optional[str] = Field(..., description="Tên khu vực")
    branch_console: Optional[str] = Field(..., description="Mã branch console")
    branch_console_name: Optional[str] = Field(..., description="Tên branch console")
