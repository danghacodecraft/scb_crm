...
from app.api.v1.endpoints.user.profile.work_profile.decisive_contract import \
    view as views_decisive_contract
from app.api.v1.endpoints.user.profile.work_profile.process import \
    view as views_work_process
from app.api.v1.endpoints.user.profile.work_profile.work_profile import \
