...
class TransactionListResponse(BaseSchema):
    ...
    customer_cif_full_name_vn: Optional[str] = Field(None, description="Họ tên khách hàng")
    sender_cif_number: Optional[str] = Field(..., description="CIF number người làm giao dịch")
    sender_full_name_vn: Optional[str] = Field(..., description="Tên người làm giao dịch")
