...
GROUP_ROLE_CODE_VIEW_EX = 'EKYC_VI_EX'
GROUP_ROLE_CODE_AP_EX = 'EKYC_AP_EX'
GROUP_ROLE_CODE_IN_EX = 'EKYC_IN_EX'
is_success = 'Success'
...
MESSAGE_SMS_INVALID = 'SCB kinh thong bao Tai khoan truc tuyen cua Quy khach can xac minh them thong tin, Quy Khach vui long den SCB gan nhat/lien he Hotline 19006538 de duoc ho tro.'
