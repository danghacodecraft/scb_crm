...
BUSINESS_FORM_EB = "EB"
BUSINESS_FORM_SMS_CASA = "SMS_CASA"
...
PROFILE_HISTORY_DESCRIPTIONS_INIT_REDEEM_TD_ACCOUNT = "Tất toán tài khoản tiết kiệm"
...
PROFILE_HISTORY_DESCRIPTIONS = {
    ...
    BUSINESS_TYPE_CODE_REDEEM_OPEN_TD: {
        ...
        'content': "Giao dịch viên đang chuẩn bị hồ sơ. "
                   "Mốc thời gian tính từ lúc GDV điền thông tin tab đầu tiên "
                   f"[{PROFILE_HISTORY_DESCRIPTIONS_INIT_REDEEM_TD_ACCOUNT}]"
    },
