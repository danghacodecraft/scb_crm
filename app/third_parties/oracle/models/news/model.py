...
class News(Base):
    ...
    category_id = Column(ForeignKey('crm_news_category.news_category_id'), VARCHAR(36), nullable=False, comment='Chuyên mục')
    ...
    created_at = Column('created_at', DateTime, nullable=False, comment='Ngày tạo', server_default=text("sysdate "))
