...
class BookingAuthentication(Base):
    ...
    tablet_id = Column(VARCHAR(36), comment='ID tablet lúc thực hiện phiên giao dịch')
    ...
    cif_number = Column(ForeignKey('crm_customer.cif_num'), comment='ID khách hàng (nếu có)')
